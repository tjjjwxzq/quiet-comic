...
Gem::Specification.new do |spec|
  ...
  spec.files         = `git ls-files -z`.split("\x0").select { |f| f.match(%r{^(_layouts|_includes|_sass|setup_files|LICENSE|README|pages_feed.xml|artworks_feed.xml|combined_feed.xml|_config.yml)}i) }
